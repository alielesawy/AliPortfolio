...
const seo = {
  ...
  og: {
    ...
    type: "website",
    url: "https://alielesawy/github.io/alielesawy.github.io",
  },
};

//Home Page
const greeting = {
  title: "Ali Esmaeil El-esawy",
  logo_name: "AliEsmail",
  ...
  githubProfile: "https://github.com/alielesawy/",
};
...
const socialMediaLinks = [
  ...
  {
    name: "Github",
    link: "https://github.com/alielesawy/",
    fontAwesomeIcon: "fa-github", // Reference https://fontawesome.com/icons/github?style=brands
    backgroundColor: "#181717", // Reference https://simpleicons.org/?q=github
  },
  {
    name: "LinkedIn",
    link: "https://www.linkedin.com/in/alielesawy/",
  ...
  {
    name: "Gmail",
    link: "mailto:alielesawy811@gmail.com",
...
const skills = {
  data: [
    {
      title: "(Java SE,SQL Server, Git)",
      fileName: "FullStackImg",
      skills: [
        "⚡ Create interactive desktop applications using the Java Swing library or integrate with existing UI frameworks",
        "⚡ Structure code effectively with classes, objects, inheritance, polymorphism, and encapsulation.",
        "⚡ Handle multiple tasks concurrently, improving responsiveness and performance for complex applications.",
        "⚡ Gracefully manage errors and unexpected situations, ensuring application stability.",
        "⚡ Build programs that communicate across networks, access databases, and interact with files.",
      ],
      softwareSkills: [
        {
          skillName: "Java",
